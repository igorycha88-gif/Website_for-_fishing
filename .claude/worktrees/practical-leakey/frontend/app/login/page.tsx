...
function LoginContent() {
  ...
  useEffect(() => {
    ...
    if (emailFromQuery) {
      setFormData({ ...formData, email: emailFromQuery });
    }
  }, [searchParams]);
    ...
    try {
      ...
      if (response.ok && data.access_token) {
        ...
        if (userResponse.ok) {
          ...
          const redirectPath = (userData.role === "admin" || userData.role === "moderator") ? "/admin" : "/profile";
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          <div>
            ...
            <div className="relative">
              <Mail className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-400" data-testid="login-email-icon" />
              <input
                type="email"
                required
          ...
          <div>
            ...
            <div className="relative">
              <Lock className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-400" data-testid="login-password-icon" />
              <input
                type="password"
                required
