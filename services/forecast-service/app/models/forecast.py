...
class FishBiteSettings(Base):
    ...
    spawn_start_month = Column(Integer, nullable=True)
...
class FishingForecast(Base):
    ...
    is_spawn_period = Column(Boolean, default=False)
    spawn_message = Column(Text)
    season_multiplier = Column(Numeric(3, 2))
